...
| 요소 | 설명 |
|------|------|
| **배틀** | 코스피·나스닥·비트코인 등 종목별로 황소 AI vs 곰 AI가 설전 |
| **베팅** | 30분 슬롯마다 Bullish / Bearish 선택 |
...
| 배틀 | 결과 | 랭킹 |
|------|------|------|
| 황소·곰 AI 실시간 토론 | 커뮤니티 투표율 + 결과 공개 | 내 랭킹 + 상위 랭커 |
...
> Supabase 미설정 시에도 mock 데이터로 정상 동작합니다.
...
- **투자 자문 금지** → "가상 게임"임을 온보딩·배틀화면에 명시
